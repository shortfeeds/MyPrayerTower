...
const sidebarItems = [
    ...
    // { href: '/dashboard/prayer-corner', icon: BookHeart, label: 'Prayer Journal' }, // Moved to /journey
...
export function DashboardLayoutClient({
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex">
            {/* Sidebar */}
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent z-50">
                {/* Logo */}
                <div className="p-6 border-b border-gray-100 sticky top-0 bg-white z-10">
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <span className="text-xs text-gray-500">Parish Dashboard</span>
                        </div>
                    </Link>
                </div>
