        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
                    ...
                    {/* User Content */}
                    <h2>4. Virtual Offerings and Memorials</h2>
                    <p>MyPrayerTower offers various virtual spiritual services including candles, Mass offerings, spiritual bouquets, and digital memorials ("Offerings").</p>
                    <ul>
                    ...
                    <h2>5. Abandoned Transactions</h2>
                    <p>If you initiate a transaction but do not complete it, we may retain your provided contact information to send reminders about your pending offering, subject to our Privacy Policy.</p>
