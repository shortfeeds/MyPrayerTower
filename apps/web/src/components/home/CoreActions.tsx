                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {CORE_ACTIONS.map((action, idx) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={`bg-gradient-to-br ${action.bgColor} rounded-3xl p-8 border border-gray-100 hover:shadow-xl transition-all duration-300 group`}
                        >
                            <div className={`w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-6 ${action.iconColor} group-hover:scale-110 transition-transform`}>
