...
*The Latin Mass has transformed the prayer lives of millions. If you are curious, take the leap. Download the [MyPrayerTower app](https://play.google.com/store/apps/details?id=com.myprayertower.myprayertower_app) for daily prayers in the Catholic tradition, and use our [Church Finder](/churches) to locate a parish near you.*
