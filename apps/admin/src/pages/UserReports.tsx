...
export function UserReports() {
    ...
    const fetchReports = async () => {
        ...
        try {
            ...
            // Fetch user reports
            const userRes = await api.get(`/admin/reports/users?startDate=${startDate}&endDate=${endDate}`);
            setUserReports(userRes.data.users || userRes.data || []);

            // Fetch revenue reports
            const revenueRes = await api.get(`/admin/reports/revenue?startDate=${startDate}&endDate=${endDate}`);
            setRevenueReports(revenueRes.data.transactions || revenueRes.data || []);
        } catch (err) {
