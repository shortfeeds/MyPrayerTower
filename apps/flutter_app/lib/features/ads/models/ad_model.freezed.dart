...
mixin _$AdModel {
  ...
  String get adSource =>
      throw _privateConstructorUsedError; // 'OFFLINE' or 'GOOGLE'
...
class _$AdModelImpl implements _AdModel {
  ...
  @override
  String toString() {
    return 'AdModel(id: $id, adSource: $adSource, imageUrl: $imageUrl, linkUrl: $linkUrl, googleAdUnitId: $googleAdUnitId, altText: $altText, position: $position)';
  }
...
abstract class _AdModel implements AdModel {
  const factory _AdModel({
    ...
    required final String adSource,
    final String? imageUrl,
    final String? linkUrl,
    final String? googleAdUnitId,
    final String? altText,
  ...
  String get id;
  @override
  String get adSource; // 'OFFLINE' or 'GOOGLE'
  @override
  String? get imageUrl;
  @override
  String? get linkUrl;
